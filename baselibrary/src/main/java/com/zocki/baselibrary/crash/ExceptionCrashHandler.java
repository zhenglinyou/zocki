package com.zocki.baselibrary.crash;
...
import static com.zocki.baselibrary.logger.LogUtils.TAG;
...
public class ExceptionCrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public static ExceptionCrashHandler getInstance() {
        if( mInstance == null ) mInstance = new ExceptionCrashHandler();
        return mInstance;
    }
    ...
    public void uncaughtException(Thread t, Throwable ex) {
        ...
        // 系统默认处理，不设置，app不知道怎么做，我们也可以退出当前页面，返回上一个页面
        // 具体的crash信息 由系统决定
